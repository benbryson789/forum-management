...
const Navbar = ({ handleSearch, setSearchText }) => {
    ...
    <div className="container">
        ...
        <div className="row row2">
            ...
            <div className="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                <div className="row">
                    <input className="flipkart-navbar-input col-md-11" type="" placeholder="Search forum by author or title" name="" onChange={(e) => setSearchText && setSearchText(e.target.value)}/>
                    <button className="flipkart-navbar-button col-md-1" onClick={handleSearch && handleSearch}>
